...
const v3_wethgateway_contract_1 = require("../v3-wethgateway-contract");
class PoolBundle extends BaseService_1.default {
    constructor(provider, lendingPoolConfig) {
        ...
        this.wethGatewayService = new v3_wethgateway_contract_1.WETHGatewayService(provider, this.erc20Service, WETH_GATEWAY);
