...
exports.gasLimitRecommendations = {
    ...
    [types_1.ProtocolAction.umbrellaStake]: {
        limit: '400000',
        recommended: '400000',
    },
    [types_1.ProtocolAction.umbrellaStakeWithPermit]: {
        limit: '310000',
        recommended: '310000',
    },
    [types_1.ProtocolAction.umbrellaStakeWithATokens]: {
        limit: '310000',
        recommended: '310000',
    },
    [types_1.ProtocolAction.umbrellaStakeWithATokensWithPermit]: {
        limit: '310000',
        recommended: '310000',
    },
    [types_1.ProtocolAction.umbrellaRedeem]: {
        limit: '310000',
        recommended: '310000',
    },
    [types_1.ProtocolAction.umbrellaRedeemATokens]: {
        limit: '310000',
        recommended: '310000',
    },
    [types_1.ProtocolAction.umbrellaStakeTokenCooldown]: {
        limit: '60000',
        recommended: '60000',
    },
    [types_1.ProtocolAction.umbrellaStakeTokenDeposit]: {
        limit: '200000',
        recommended: '200000',
    },
    [types_1.ProtocolAction.umbrellaStakeTokenDepositWithPermit]: {
        limit: '300000',
        recommended: '300000',
    },
    [types_1.ProtocolAction.umbrellaStakeTokenRedeem]: {
        limit: '200000',
        recommended: '200000',
    },
    [types_1.ProtocolAction.umbrellaClaimAllRewards]: {
        limit: '310000',
        recommended: '310000',
    },
    [types_1.ProtocolAction.umbrellaClaimSelectedRewards]: {
        limit: '310000',
        recommended: '310000',
    },
    [types_1.ProtocolAction.umbrellaStakeGatewayStake]: {
        limit: '310000',
        recommended: '310000',
    },
    [types_1.ProtocolAction.umbrellaStakeGatewayStakeWithPermit]: {
        limit: '310000',
        recommended: '310000',
    },
    [types_1.ProtocolAction.umbrellaStakeGatewayStakeATokens]: {
        limit: '310000',
        recommended: '310000',
    },
    [types_1.ProtocolAction.umbrellaStakeGatewayStakeATokensWithPermit]: {
        limit: '310000',
        recommended: '310000',
    },
    [types_1.ProtocolAction.umbrellaStakeGatewayStakeNativeTokens]: {
        limit: '310000',
        recommended: '310000',
    },
    [types_1.ProtocolAction.umbrellaStakeGatewayRedeem]: {
        limit: '310000',
        recommended: '310000',
    },
    [types_1.ProtocolAction.umbrellaStakeGatewayRedeemATokens]: {
        limit: '310000',
        recommended: '310000',
    },
    [types_1.ProtocolAction.umbrellaStakeGatewayRedeemNativeTokens]: {
        limit: '310000',
        recommended: '310000',
    },
};
...
const makePair = (id) => {
    const privateKey = ethers_1.utils.id(id);
    const address = ethers_1.utils.computeAddress(privateKey);
    return { privateKey, address };
};
exports.makePair = makePair;
exports.DEFAULT_MOCK_VERIFYING_CONTRACT = '0xCcCCccccCCCCcCCCCCCcCcCccCcCCCcCcccccccC';
const generateEIP712PermitMock = (owner, spender, amount, deadline) => {
    const domain = {
        name: 'Mocked token',
        version: '1',
        chainId: 1,
        verifyingContract: exports.DEFAULT_MOCK_VERIFYING_CONTRACT,
    };
    const types = {
        Permit: [
...
exports.generateEIP712PermitMock = generateEIP712PermitMock;
