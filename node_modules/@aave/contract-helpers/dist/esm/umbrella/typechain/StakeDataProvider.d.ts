...
export declare type StataTokenDataStruct = {
    asset: string;
    assetName: string;
    assetSymbol: string;
    aToken: string;
...
export declare type StataTokenDataStructOutput = [
    string,
    string,
    string,
    string,
...
export declare type RewardStruct = {
...
export declare type RewardStructOutput = [
    string,
    string,
    string,
    BigNumber,
...
export declare type StakeDataStruct = {
    tokenAddress: string;
    name: string;
    symbol: string;
    price: BigNumberish;
...
export declare type StakeDataStructOutput = [
    string,
    string,
    string,
    BigNumber,
...
export declare type StakeUserBalancesStruct = {
...
export declare type StakeUserBalancesStructOutput = [
    BigNumber,
    BigNumber,
    BigNumber,
    BigNumber,
...
export declare type StakeUserCooldownStruct = {
    cooldownAmount: BigNumberish;
    endOfCooldown: BigNumberish;
    withdrawalWindow: BigNumberish;
};
export declare type StakeUserCooldownStructOutput = [BigNumber, number, number] & {
    cooldownAmount: BigNumber;
    endOfCooldown: number;
    withdrawalWindow: number;
};
export declare type StakeUserDataStruct = {
    stakeToken: string;
...
export declare type StakeUserDataStructOutput = [
    string,
    string,
...
export interface StakeDataProviderInterface extends utils.Interface {
    ...
    getFunction(nameOrSignatureOrTopic: 'aaveOracle' | 'getStakeData' | 'getUserStakeData' | 'rewardsController' | 'stataTokenFactory' | 'umbrella'): FunctionFragment;
