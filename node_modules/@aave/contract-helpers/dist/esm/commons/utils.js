...
export const makePair = (id) => {
    const privateKey = utils.id(id);
    const address = utils.computeAddress(privateKey);
    return { privateKey, address };
};
export const DEFAULT_MOCK_VERIFYING_CONTRACT = '0xCcCCccccCCCCcCCCCCCcCcCccCcCCCcCcccccccC';
export const generateEIP712PermitMock = (owner, spender, amount, deadline) => {
    const domain = {
        name: 'Mocked token',
        version: '1',
        chainId: 1,
...
export function expectToBeDefined(value) {
