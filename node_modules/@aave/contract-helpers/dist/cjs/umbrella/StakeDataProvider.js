...
exports.StakeDataProviderService = void 0;
const StakeDataProvider__factory_1 = require("./typechain/StakeDataProvider__factory");
class StakeDataProviderService {
    constructor(stakeDataProviderAddress, provider) {
        this._contract = StakeDataProvider__factory_1.StakeDataProvider__factory.connect(stakeDataProviderAddress, provider);
    }
    async getStakeData() {
...
exports.StakeDataProviderService = StakeDataProviderService;
